...
<div class="container mt-5 p-4 mb-5" style="background-color: #e3f2fd;">
   ...
   <form action="" method="post" enctype="multipart/form-data">
     ...
     <div class="from-outline w-50 m-auto mb-4">
        <label for="product_desc" class="from-label">Product Description</label>
     ...
     <div class="from-outline w-50 m-auto mb-4">
     <label for="product_category" class="from-label">Product Categories</label>
        <select name="product_category" class="form-select">
            <option value="<?php echo $category_title; ?>"><?php echo $category_title; ?>
        </option>
        <?php
     ...
     <label for="product_brands" class="from-label">Product Brands</label>
        <select name="product_brands" class="form-select">
            <option value="<?php echo $brand_title; ?>"><?php echo $brand_title; ?>
        </option>
        <?php
     ...
     <div class="from-outline w-50 m-auto mb-4">
        ...
        <div class="d-flex">
            <input type="file" id="product_image3" name="product_image3" class="form-control w-90 m-auto" require="required">
     ...
     <div class="text-center mb-3">
        <input type="submit" name="edit_product" class="btn btn-success p-2" value="Update Product">
     </div>
...
if(isset($_POST['edit_product'])){
   ...
   if($product_title == '' or $product_desc == '' or $product_keywords == '' or $product_category == '' or $product_brands == '' or $product_price == '' or $product_image1 == '' or $product_image2 == '' or $product_image3 == '' ){
    ...
    category_id = '$product_category', brand_id = '$product_brands', product_image1 = '$product_image1', product_image2 = '$product_image2', product_image3 = '$product_image3',
