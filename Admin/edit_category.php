...
<div class="container mt-3" style="background-color: #e3f2fd;">
    ...
    <form action="" method="post" class="text-center">
       <div class="form-outline mb-4 w-50 m-auto">
          <label for="category_title" class="form-label">Category title</label> <br>
          <input type="text" name="category_title" id="category_title" class="form_control" required="required" value ="<?php  echo $category_title ?>">
       </div>
       <input type="submit" value="Update Category" class="btn btn-success px-3 mb-5" name="edit_cat">
    </form>
</div>