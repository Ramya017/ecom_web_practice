...
if(isset($_POST['insert_product'])){
   ...
   //checking if all fields are filled, or if any of them is empty
...
<body  class = " bg-light" >
   ...
   ?>
            ...
            <!-- Submit button -->
            <div class="form-outline mb-4 w-50 m-auto">
               <input type="submit" name="insert_product" class="btn btn-success mb-4 px-3" value="Insert Product">
            </div>
      </form>
   </div>
...
<!-- you made a typo and so it was throwing an error -->