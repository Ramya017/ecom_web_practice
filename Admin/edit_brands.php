...
<div class="container mt-3" style="background-color: #e3f2fd;">
    ...
    <form action="" method="post" class="text-center">
       <div class="form-outline mb-4 w-50 m-auto">
          <label for="brand_title" class="form-label">Brand title</label> <br>
          <input type="text" name="brand_title" id="brand_title" class="form_control" required="required" value ="<?php  echo $brand_title ?>">
       </div>
       <input type="submit" value="Update brand" class="btn btn-success px-3 mb-5" name="edit_brand">
    </form>
</div>