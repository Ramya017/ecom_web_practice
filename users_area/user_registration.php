...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data" >
        ...
        <!-- user Image field -->
        <div class="form-outline mb-4">
            <label for="user_image" class="form-label">Add image</label>
            <input type="file" id="user_image" class="form-control" required = "required" name="user_image"/>
        </div>
        <!-- password field -->
        <div class="form-outline mb-4">
            <label for="user_password" class="form-label">Password
            </label>
        ...
        <p class="mb-0"><b>Already have an account ?
            <a href="user_login.php" class="text-danger"> Login</a></b>
        </p>
        </div>
    </form>
